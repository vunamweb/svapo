...
class ModelCatalogCategory extends Model {
    ...
    public function getCategoryAttribute($attribute_group_id) {
        ...
        foreach ( $query->rows as $row ) {
            if($attribute_group_id == 11)
             $response .= '<span class="nav-link col-xl-2 col-lg-3 col-6 col-md-4 text-secondary text2 no-wrap"><input id="check_'.$row['attribute_id'].'" type="radio" name="filter_atb_'.$attribute_group_id.'" class="filter_attribute" data="'.$row['attribute_id'].'_radio"/><label class="label_atb" for="check_'.$row['attribute_id'].'">'.$row[ 'name' ].'</label></span>';
            else
             $response .= '<span class="nav-link col-xl-2 col-lg-3 col-6 col-md-4 text-secondary text2 no-wrap"><input id="check_'.$row['attribute_id'].'" type="checkbox" class="filter_attribute" data="'.$row['attribute_id'].'"/><label class="label_atb" for="check_'.$row['attribute_id'].'">'.$row[ 'name' ].'</label></span>';
        }

...
class ControllerCommonDashboard extends Controller {
	public function index() {
			  ...
			  if (isset($this->request->get['foi']) && !empty($this->request->get['foi'])) {
				  $url = 'sale/order';
				  $typedata = $this->request->get['foi'];
				  $type = 'filter_order_id';
			  }
			  ...
			  if (isset($this->request->get['fcustomer_email']) && !empty($this->request->get['fcustomer_email'])) {
				$url = 'sale/order';
				$typedata = $this->request->get['fcustomer_email'];
				$type = 'filter_email';
			}
			  if (isset($this->request->get['fmodel']) && !empty($this->request->get['fmodel'])) {
				  $url = 'catalog/product';
				  $typedata = $this->request->get['fmodel'];
				  $type = 'filter_model';
			  }


			  if (isset($url)) {
				  $this->response->redirect($this->url->link($url,'user_token=' . $this->session->data['user_token']. '&'.$type.'='.$typedata, true));
			  }

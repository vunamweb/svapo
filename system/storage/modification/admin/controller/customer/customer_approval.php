...
class ControllerCustomerCustomerApproval extends Controller {
	public function index() {
		...
		if (isset($this->request->get['filter_email_approved'])) {
			$filter_email_approved = $this->request->get['filter_email_approved'];
		} else {
			$filter_email_approved = '';
		}
		...
		if (isset($this->request->get['filter_email_approved'])) {
			$url .= '&filter_email_approved=' . $this->request->get['filter_email_approved'];
		}
		...
		$data['filter_email_approved'] = $filter_email_approved;
	...
	public function customer_approval() {
		...
		$filter_data = array(
			'filter_email_approved' => $filter_email_approved,
		...
		foreach ($results as $result) {
			$data['customer_approvals'][] = array(
				'email_approved' => $result['email_approved'],

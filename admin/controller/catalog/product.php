...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getListExport($export="flowzz") {
        ...
        $data[ 'copy' ] = $this->url->link( 'catalog/product/copy', 'user_token=' . $this->session->data[ 'user_token' ] . $url, true );
        $data[ 'delete' ] = $this->url->link( 'catalog/product/delete', 'user_token=' . $this->session->data[ 'user_token' ] . $url, true );
        $data[ 'export' ] = $this->url->link( 'catalog/product/ViewExport', 'user_token=' . $this->session->data[ 'user_token' ] . $url, true );
        ...
        if ( $_POST ) {
            ...
            foreach ( $results as $result ) {
				...
				$attributes_list = $this->model_catalog_product->getListNameAttributeProduct($result['attributes']);

				$productAttribute = '';

				foreach($attributes_list as $group) {
					$listAttribute = $group['list'];
        ...
        $this->response->setOutput( $this->load->view( 'catalog/product_list_export', $data ) );
    }

...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Anwendung";
$titel			= "Anwendung";
///////////////////////////////////////////////////////////////////////////////////////
$table 		= 'morp_product_anwendung';
$tid 		= 'anID';
$nameField 	= "anwendung";
// $sortField 	= 'reihenfolgeC';

$table2 		= 'morp_product_wg';
$tid2 		= 'wgID';
$nameField2 	= "wg";
...
global $anwendung_arr;

$imgFolder = "../images/anwendung/";
$imgFolderShort = "anwendung/";
...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("anwendung", "Name Anwendung / Headline", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("headerText1", "Text über Headerbild klein", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("headerText2", "Text über Headerbild groß", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("color",  "Textfarbe", 'dropdown_array', array('black'=>"schwarz", "white"=>"weiss")),
	
	array("", "CONFIG", '</div><div class="col-md-6">'),
 	array("wgID",  "Warengruppe", 'sel2', $table2, $nameField2, $tid2),
	array("anwID",  "Anwendung Bereich", 'dropdown_array', $anwendung_arr),
	array("webshop", "Webshop Url", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	 
	 
	array("", "CONFIG", '</div><div class="col-md-12">'),
	array("", "CONFIG", '</div><div class="col-md-6">'),
 	array("html", "Text (links)", '<textarea class="form-control summernote" name="#n#">#v#</textarea>'),
	array("", "CONFIG", '</div><div class="col-md-6">'),
 	array("liste", "Bedienungsoptionen (rechts)", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	array("", "CONFIG", '</div><div class="col-md-12">'),
	// array("logo", "Logo", 'foto', 'image', 'imgname', 6, 'gid'),
	array("img", "Header Bild (1920 x 600)", 'foto', 'image', 'imgname', 6, 'gid'),
...
';
	...
	$sql = "SELECT * FROM $table WHERE $where ORDER BY wgID, $tid";
	$res = safe_query($sql);

...
/////////////////////////////////////////////////////////////////////////////////////////////////////
// $sql = "ALTER TABLE  $table ADD  `anw_text5` TEXT NULL DEFAULT NULL";
// safe_query($sql);
/////////////////////////////////////////////////////////////////////////////////////////////////////

$arr_form = array(
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("wg", "Warengruppe", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("wgnavbar", "Warengruppe Name in Navigation", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("wgtitle", "SEO Title", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("wgdesc", "SEO Description", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
 	// array("faq", "Text", '<textarea class="form-control summernote" name="#n#">#v#</textarea>'),
 	// array("faq", "Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
 	// array("catId",  "Category", 'sel2', $table2, $nameField2, $tid2),
	// array("logo", "Logo", 'foto', 'image', 'imgname', 6, 'gid'),
	array("imgWG", "Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	
	array("", "CONFIG", '</div><div class="col-md-6"><p><b><u>Anwendungen</u></b></p>'),
	
	array("anw1", "Privatbereich Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("anw_text1", "Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	
	array("anw2", "Smart Home Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("anw_text2", " Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	
	array("", "CONFIG", '</div><div class="col-md-6">'),
	
	// array("img2", "xxx Foto<br>600px Breite", 'foto', 'image', 'imgname', 6, 'gid'),
	array("img_hersteller", "Hersteller Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("img_produkte", "Produkte Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("img_anwendungen", "Anwendungen Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	
	array("", "CONFIG", '</div><div class="col-md-6">'),

	
	array("anw3", "Handel, Gewerbe Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("anw_text3", "Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	
	array("anw4", "Behörden, öffentliche Einrichtungen Anwendung Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("anw_text4", "Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	
	array("anw5", "Werteschutz Foto", 'foto', 'image', 'imgname', 6, 'gid'),
	array("anw_text5", "Text", '<textarea class="form-control" name="#n#">#v#</textarea>'),
);
...
function edit($edit) {
	global $arr_form, $table, $tid, $imgFolder, $imgFolderShort, $um_wen_gehts, $imageNameZusatz;

...
$imgFolder = "../images/sorten/";
$imgFolderShort = "sorten/";
...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array($nameField, "Name der Sorte", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("status", "Status", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
 	array("weitere", "Weitere Namen", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	 array("herkunft", "Herkunft", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	 array("story", "Story", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	 array("beurteilung", "Beurteilung", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	 // array("weitere", "Weitere Namen", '<textarea class="form-control" name="#n#">#v#</textarea>'),
	// array("status", "Weitere Namen", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
 	// array("catId",  "Category", 'sel2', $table2, 'category', $tid2),
	array("img", "Foto<br>600px Breite", 'foto', 'image', 'imgname', 6, 'gid'),
);
...
';
	...
	<div class="zeile item row"  id="'.$row->$tid.'">
			...
			<div class="col-md-2">
			<img src="mthumb.php?h=30&amp;src='.$imgFolder.urlencode($row->img).'" alt="">
			</div>

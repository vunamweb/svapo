...
';
	...
	echo '<form method="post"><input type="Hidden" name="save" value="'.$edit.'"><input type="Hidden" name="new" value="'.$neu.'">';
	...
	while ($row = mysqli_fetch_object($result)) {
		...
		$lnk = '<a name="orte" href="?edit='.$id.'" title="orte">';
		
		echo '<tr bgcolor='.$col[$ct].'><td valign="top" align="right">'.$lnk.''.$x.'</a> &nbsp;</td><td valign="top">'.$lnk.''.$stadt.' ('.$id.')</a></td><td valign="top">'.$vort.'</td><td valign="top">'.$text.'</td><td>'.$lnk.'<img src="images/edit.gif" alt="" width="18" height="10" border="0"></a></td><td><a name="orte" href="?del='.$id.'" title="orte"><img src="images/delete.gif" alt="" border="0"></a></td></tr>
		';
...
echo '</table>
';
if (!$edit) echo '<p><a name="neu" href="?neu=1" title="neu">'.ilink().' NEU</a></p>
';
?>

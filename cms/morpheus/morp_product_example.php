...
///////////////////////////////////////////////////////////////////////////////////////
//// EDIT_SKRIPT
$um_wen_gehts 	= "Anwendungsbeispiele";
$titel			= "Anwendungsbeispiele";
///////////////////////////////////////////////////////////////////////////////////////
$table 		= 'morp_product_example';
$tid 		= 'exID';
$nameField 	= "example";
// $sortField 	= 'reihenfolgeEX';
...
$imgFolder = "../images/example/";
$imgFolderShort = "example/";
...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("example", "Name Beispiel", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	...
	array("img", "Foto", 'foto', 'image', 'imgname', 6, 'gid'),
...
function edit($edit) {
	...
	// HIS Special
	$imageNameZusatz = eliminiere($row->company);

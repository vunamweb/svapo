...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("produkt", "Name Produkt", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	...
	array("img", "Produkt Bild (.... x ...)", 'foto', 'image', 'imgname', 6, 'gid'),
);

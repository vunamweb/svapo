...
$imgFolder = "../images/produkt/";
$imgFolderShort = "produkt/";
...
$arr_form = array(
	...
	array("pcID",  "Company", 'sel2', $table2, $nameField2, $tid2),
	 array("peID",  "Proddukt", 'sel2', $table4, $nameField4, $tid4),
...
function liste() {
	...
	global $table3, $tid3, $sortField3, $nameField3;
	global $table4, $tid4, $sortField4, $nameField4;
	...
	////////////////////
	$where = " t1.$tid2=t2.$tid2 AND t1.$tid3=t3.$tid3 AND t1.$tid4=t4.$tid4 ";
	// $where = " 1 ";
...
';
	...
	$sql = "SELECT t1.webshop, t1.$tid, t1.$tid2, t1.$tid3, t1.$tid4, t2.$nameField2, t3.$nameField3, t4.$nameField4 FROM $table t1, $table2 t2, $table3 t3, $table4 t4 WHERE $where ORDER BY ".$ord."";
	...
	<div class="row" style="background:'.$bgcol.'">
			...
			<div class="col-md-1">
				<a href="?edit='.$edit.'">'.$row->$nameField2.' </a>
			</div>
			<div class="col-md-2">
				<a href="?edit='.$edit.'">'.$row->$nameField3.' </a>
			</div>
			<div class="col-md-2">
				<a href="?edit='.$edit.'">'.$row->$nameField4.' </a>
			</div>
			<div class="col-md-3">
				<a href="?edit='.$edit.'">'.$row->webshop.' </a>
			</div>

...
$imgFolder = "../images/hersteller/";
$imgFolderShort = "hersteller/";
...
//	array("reihenfolge", "Reihenfolge", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
	array("company", "Name Hersteller", '<input type="Text" value="#v#" class="form-control" name="#n#" />'),
